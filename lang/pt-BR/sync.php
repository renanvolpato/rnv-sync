...
return [
    ...
    'clear_history_confirm' => 'Apagar o histórico de sincronização? (execuções em andamento são mantidas)',
    'history_cleared' => 'Histórico de sincronização limpo.',
    'sync_now' => 'Sincronizar agora',
    'manage_files' => 'Arquivos / manter offline',
    ...
    'status_error' => 'última sincronização falhou',
    'status_partial' => 'última sincronização parcial',
    ...
    'col_status' => 'Status',
    'col_files' => 'Arquivos',
    'col_bytes' => 'Transferido',

    'rate_limited' => 'A Microsoft está limitando as requisições temporariamente. Retomando automaticamente em alguns minutos.',
];
